...
import (
	...
	github_com_subrahamanyam341_andes_xyz_data_vm "github.com/subrahamanyam341/andes-xyz/data/vm"
	io "io"
	math "math"
	math_big "math/big"
	math_bits "math/bits"
...
type SmartContractResult struct {
	...
	RelayedValue   *math_big.Int                                          `protobuf:"bytes,6,opt,name=RelayedValue,proto3,casttypewith=math/big.Int;github.com/subrahamanyam341/andes-xyz/data.BigIntCaster" json:"relayedValue"`
	...
	CallType       github_com_subrahamanyam341_andes_xyz_data_vm.CallType `protobuf:"varint,13,opt,name=CallType,proto3,casttype=github.com/subrahamanyam341/andes-xyz/data/vm.CallType" json:"callType"`
...
func (m *SmartContractResult) GetCallType() github_com_subrahamanyam341_andes_xyz_data_vm.CallType {
	if m != nil {
		return m.CallType
	}
	return 0
...
var fileDescriptor_edc1605de0d3d805 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CallType |= github_com_subrahamanyam341_andes_xyz_data_vm.CallType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
