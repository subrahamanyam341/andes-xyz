//go:generate protoc -I=. -I=$GOPATH/src/github.com/subrahamanyam341/andes-xyz/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/dharitri-org/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
